<h2> Die Voranmeldung ist zur Zeit aktiviert </h2>
        ...
        if(!isset($_GET["step"])){
            ...
            echo '
                ...
                <table style="margin: auto">
                    <tr> <td>Jahr des nächsten Lagers</td><td><input type="text" value='.$jahr.'></td></tr>
                    <tr> <td>Anfang des nächsten Lagers</td><td><input type="text" value='.$anfang.'></td></tr>
                    <tr> <td>Ende des nächsten Lagers</td><td><input type="text" value='.$ende.'></td></tr>
