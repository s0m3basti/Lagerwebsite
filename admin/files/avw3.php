...
<?php
    ...
    try{
        ...
        echo "<tr class='avw_head'><td class='avw_head avw_id'></td><td class='avw_head'>Vorname des Teilnehmers</td><td class='avw_head'>Nachname des Teilnehmers</td><td class='avw_head'>Geschlecht</td><td class='avw_head'>Geburtstag</td><td class='avw_head'>Alter im Lager</td><td class='avw_head'>Vorname des Erzb</td><td class='avw_head'>Nachname des Erzb</td><td class='avw_head'>Straße</td><td class='avw_head'>Postleitzahl</td><td class='avw_head'>Ort</td><td class='avw_head'>Telefon (privat)</td><td class='avw_head'>Telefon (Handy)</td><td class='avw_head'>Telefon (dienstl.)</td><td class='avw_head'>E-Mail-Adresse</td><td class='avw_head'>Mitglied</td><td class='avw_head'>Mitarbeiter</td><td class='avw_head'>Schwimmer</td><td class='avw_head'>Schwimmstufe</td><td class='avw_head'>Badeerlaubnis</td><td class='avw_head'>Springen ins Wasser</td><td class='avw_head'>Ernaehrung</td><td class='avw_head'>Krankheiten</td><td class='avw_head'>Medikamente</td><td class='avw_head'>Taschengeld</td><td class='avw_head'>Art der Versciherung</td><td class='avw_head'>Name der Versicherung</td><td class='avw_head'>Ptivate KFZ</td><td class='avw_head'>Ratenzahlung</td><td class='avw_head'>Tshirts</td><td class='avw_head'>Umfrage</td><td class='avw_head'>Art</td><td class='avw_head'>Datum der Anmeldung</td><td class='avw_head'>IP-Adresse der Anmeldung</td></tr>";
