    ...
    <body>
        ...
        <div class="bg"> 
            <div id="Inhalt">
                ...
                <div class="fb-page" data-href="https://www.facebook.com/DRK.Sommercamp/" data-tabs="timeline" data-width="800" data-height="800" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false" style="text-align:center; display:block;"><blockquote cite="https://www.facebook.com/DRK.Sommercamp/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/DRK.Sommercamp/">DRK Sommercamp</a></blockquote></div>
                <hr>
                <div class="news"><p>
                <img src="img/Header.png" alt="Informationen zum Sommercamp"  height="200px"></p></div>
                <h2>Beispiel Überschrift</h2>
                <p class="date">31.31.31</p>
                <br>
                <p>Beispieltext
